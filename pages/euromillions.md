...
---
    ...
    <div class="section">
        ...
        <div class="mt-4">
            <canvas id="chartNumbersDoughnut" height="120"></canvas>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="mt-4">
            <canvas id="chartStarsDoughnut" height="120"></canvas>
        </div>
    </div>
    ...
    new Chart(document.getElementById('chartNumbers'), {
        type: "bar",
        data: {
            labels: ["44", "23", "42", "29", "19", "21", "50", "17", "10", "25", "37", "45", "35", "20", "15", "27", "26", "7", "13", "38", "14", "24", "49", "30", "4", "5", "12", "39", "34", "11", "48", "16", "3", "6", "28", "9", "8", "36", "1", "31", "32", "2", "43", "47", "40", "41", "18", "33", "46", "22"],
            datasets: [{
                label: 'Sorties',
    ...
    new Chart(document.getElementById('chartNumbersDoughnut'), {
        type: 'doughnut',
        data: {
            labels: ["44", "23", "42", "29", "19", "21", "50", "17", "10", "25"],
            datasets: [{
                label: 'Sorties',
                data: [217, 215, 214, 212, 212, 211, 205, 205, 203, 202],
                borderWidth: 1
            }]
        },
        options: {
    ...
    new Chart(document.getElementById('chartStarsDoughnut'), {
        type: 'doughnut',
        data: {
            labels: ["3", "2", "8", "9", "6", "7", "5", "1", "4", "10"],
            datasets: [{
                label: 'Sorties',
                data: [379, 378, 365, 350, 341, 340, 338, 329, 301, 268],
                borderWidth: 1
            }]
        },
        options: {
