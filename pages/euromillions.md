...
<div class="d-flex justify-content-between align-items-start mb-3 gap-3">
    <p class="mb-0">Analyse de <span class="fw-bold">1932</span> tirages valides</p>
    <p class="mb-0">
        
            <span class="badge bg-warning text-dark ms-2">⚠ 1 tirages ignorés</span>
        

        
            Période détectée : <strong>13/02/2004</strong> → <strong>27/03/2026</strong>
        
    </p>
    <p class="mb-0 small-muted fst-italic">Généré le 31/03/2026 à 17:49</p>
</div>

<div class="row text-center mb-4 g-2">
    <div class="col-12 col-md-3">
        <div class="card p-2 p-lg-3">
        <h3 class="mb-0">1932</h3>
        <small class="text-muted">Tirages valides</small>
        </div>
    </div>
    <div class="col-12 col-md-3">
        <div class="card p-2 p-lg-3">
        <h3 class="mb-0">1933</h3>
    ...
    <div class="table-wrap">
        <table class="table table-striped table-hover sticky-head" id="numberTableFreq">
            ...
            <tbody>
                ...
                <tr><td><strong>44</strong></td><td>221</td><td>2.29%</td></tr>
                ...
                <tr><td><strong>29</strong></td><td>213</td><td>2.2%</td></tr>
                ...
                <tr><td><strong>10</strong></td><td>209</td><td>2.16%</td></tr>
                ...
                <tr><td><strong>48</strong></td><td>191</td><td>1.98%</td></tr>
                ...
                <tr><td><strong>8</strong></td><td>183</td><td>1.89%</td></tr>
    ...
    <div class="table-wrap" style="max-height:550px">
        <table class="table table-striped table-hover sticky-head" id="starTableFreq">
            ...
            <tbody>
                ...
                <tr><td>★ 3</td><td>383</td><td>9.91%</td></tr>
                
                <tr><td>★ 2</td><td>381</td><td>9.86%</td></tr>
                
                <tr><td>★ 8</td><td>367</td><td>9.5%</td></tr>
                
                <tr><td>★ 9</td><td>356</td><td>9.21%</td></tr>
                
                <tr><td>★ 6</td><td>346</td><td>8.95%</td></tr>
                
                <tr><td>★ 5</td><td>343</td><td>8.88%</td></tr>
                
                <tr><td>★ 7</td><td>342</td><td>8.85%</td></tr>
                
                <tr><td>★ 1</td><td>332</td><td>8.59%</td></tr>
                
                <tr><td>★ 4</td><td>306</td><td>7.92%</td></tr>
                
                <tr><td>★ 10</td><td>277</td><td>7.17%</td></tr>
                
                <tr><td>★ 11</td><td>261</td><td>6.75%</td></tr>
...
new Chart(document.getElementById('chartNumbers'), {
    type: "bar",
    data: {
        labels: ["44", "42", "23", "19", "29", "21", "17", "50", "10", "37", "27", "35", "25", "45", "20", "13", "26", "15", "24", "7", "14", "5", "4", "38", "12", "34", "49", "30", "39", "48", "16", "11", "6", "3", "28", "1", "9", "8", "31", "36", "43", "32", "47", "2", "41", "40", "18", "33", "46", "22"],
        datasets: [{
            label: 'Sorties',
            data: [221, 219, 217, 215, 213, 212, 211, 209, 209, 205, 204, 202, 202, 201, 201, 200, 200, 199, 199, 198, 198, 197, 196, 195, 194, 194, 193, 193, 191, 191, 190, 190, 188, 187, 186, 184, 183, 183, 182, 181, 179, 178, 178, 178, 176, 176, 173, 169, 169, 151],
...
new Chart(document.getElementById("chartStars"), {
    ...
    data: {
        ...
        datasets: [{
            label: 'Sorties',
            data: [383, 381, 367, 356, 346, 343, 342, 332, 306, 277, 261, 170],
...
new Chart(document.getElementById('chartNumbersDoughnut'), {
    ...
    data: {
        ...
        datasets: [{
            label: 'Sorties',
            data: [221, 219, 217, 215, 213, 212, 211, 209, 209, 205],
            borderWidth: 1
        }]
    },
    options: {
...
new Chart(document.getElementById('chartStarsDoughnut'), {
    ...
    data: {
        ...
        datasets: [{
            label: 'Sorties',
            data: [383, 381, 367, 356, 346, 343, 342, 332, 306, 277],
            borderWidth: 1
        }]
    },
    options: {
...
new Chart(document.getElementById("multiAxisChart"), {
    ...
    data: {
        ...
        datasets: [{
            label: 'Occurrences',
            data: [184, 178, 187, 196, 197, 188, 198, 183, 183, 209],
            yAxisID: 'y',
        ...
        {
            label: 'Pourcentage (%)',
            data: [1.9, 1.84, 1.94, 2.03, 2.04, 1.95, 2.05, 1.89, 1.89, 2.16],
            yAxisID: 'y1',
